...
#         X_data['hour'] = X_data['data'].dt.hour
#
#         # Rimozione della colonna datetime originale
#         X_data = X_data.drop('data', axis=1)
#     return X_data
...
def train_and_evaluate(X, y):
    ...
    # Ottimizzazione degli iperparametri per RandomForestRegressor e LGBMRegressor
    rf_param_grid = {
...
if __name__ == '__main__':
    X, Y = prepare_data()
    # X = convert_dates(X)
    check_target_distribution(Y)  # Check the distribution of the target variable
